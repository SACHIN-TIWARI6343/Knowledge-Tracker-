...
This project is a Knowledge Tracker App. It allows users to create, edit, delete, search, and filter notes related to learning resources. The app is a full‑stack solution with a Next.js frontend and a Spring Boot backend integrated with an H2 database.
...
- API Communication: REST APIs (GET, POST, PUT, DELETE)
...
- Run the application using Gradle/Maven
